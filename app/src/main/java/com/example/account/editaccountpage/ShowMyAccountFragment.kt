...
class Show_account_detail_fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.supportFragmentManager?.addOnBackStackChangedListener {
            (activity as Edit_account_activity?)!!.refresh_fragment(this)
    ...
    //https://stackoverflow.com/questions/23499198/fragmentmanager-popbackstack-doesnt-remove-fragment
    //https://hashcode.co.kr/questions/1484/fragment-%ED%99%94%EB%A9%B4-%EA%B5%90%EC%B2%B4%ED%95%98%EA%B8%B0
    // transaction 사용시 replace는 pop을 한다.
